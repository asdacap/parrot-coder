...
func (m builtin) ReviewPlan() bool       { return m.review }
...
func Builtins() []Mode {
	...
	return []Mode{
		...
		builtin{profile: agent.Profile{ID: PlanID, Prompt: "You are Parrot's plan mode. Inspect the project and produce an implementation plan.", AllowedToolIDs: readTools, HardRules: []string{"Read-only mode is enforced by the runtime."}, MaxTurns: 24, ReadOnly: true}, review: true},
	}
}
