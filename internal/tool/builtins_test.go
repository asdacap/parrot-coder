...
func TestRegisterBuiltinsDefinitions(t *testing.T) {
	...
	want := []string{
		"agent_interrupt", "agent_list", "agent_send", "agent_spawn", "agent_wait", "apply_patch", "create_goal", "edit", "exec_command", "get_goal", "git_diff", "glob", "grep", "monitor",
		"question", "read", "read_output", "request_write_permission", "review", "shell", "skill", "task",
		"task_cancel", "task_status", "todoread", "todowrite", "unrestricted_shell", "update_goal", "web_fetch", "write_stdin",
	}
