...
func TestRegisterBuiltinsDefinitions(t *testing.T) {
	...
	want := []string{
		...
		"question", "read", "read_output", "request_write_permission", "set_config", "shell", "skill", "status", "task_interrupt", "task_list_active", "todoread", "todowrite", "unrestricted_shell", "update_goal", "wait_task", "web_fetch", "write_stdin",
	}
